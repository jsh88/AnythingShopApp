...
<body>
	<div>
		<table>
			...
			<tr>
				<td>HOME > 회원가입 > 이용약관</td>
			</tr>
		</table>
		<div>
			<img src="resources/images/join_txt_01.gif" /><br />
			<textarea rows="10" cols="150">제1조(목적) 

이 약관은 퍼니팬시 회사(전자거래 사업자)가 운영하는 아이디어펀 사이버 몰(이하 "몰"이라 한다)에서 제공하는 인터넷 관련 서비스(이하 "서비스"라 한다)를 이용함에 있어 사이버몰과 이용자의 권리•의무 및 책임사항을 규정함을 목적으로 합니다. 
※ 「PC통신등을 이용하는 전자거래에 대해서도 그 성질에 반하지 않는 한 이 약관을 준용합니다」 


제2조(정의) 

① "몰"이란 퍼니팬시 회사가 재화 또는 용역을 이용자에게 제공하기 위하여 컴퓨터 등 정보통신설비를 이용하여 재화 또는 용역을 거래할 수 있도록 설정한 가상의 영업장을 말하며, 아울러 사이버몰을 운영하는 사업자의 의미로도 사용합니다. 
...
1. 이 약관은 0000년 00월 00일부터 적용됩니다.</textarea>
			<br /> <input type="radio" name="use" value="agree" />동의합니다 <input
				type="radio" name="use" value="notagree" />동의하지 않습니다
		</div>
		<div>
			개인정보취급방침<br />

			<textarea rows="10" cols="150">1. 개인정보 수집에 대한 동의 
아이디어펀은 이용자의 개인정보보호방침 또는 이용약관의 내용에 대해 「동의합니다」버튼 또는 「동의하지 않습니다」버튼을 클릭할 수 있는 절차를 마련하여, 「동의합니다」버튼을 클릭하면 개인정보 수집에 대해 동의한 것으로 봅니다.
...
대부분의 서비스는 별도의 사용자 등록이 없이 언제든지 사용할 수 있습니다. 그러나 아이디어펀은 회원서비스를 통하여 이용자들에게 맞춤식 서비스를 비롯한 보다 더 향상된 양질의 서비스를 제공하기 위하여 다음과 같은 목적으로 이용자 개인의 정보를 수집하고 있습니다. 
아이디어펀는 이용자의 사전 동의 없이는 이용자의 개인 정보를 공개하지 않으며, 수집된 정보는 아래와 같이 이용하고 있습니다.
...
아이디어펀는 이용자들이 회원서비스를 이용하기 위해 회원으로 가입하실 때 서비스 제공을 위한 필수적인 정보들을 온라인상에서 입력 받고 있습니다. 
...
4. 비회원의 고객 개인정보 보호
아이디어펀는 비회원 고객 또한 물품 및 서비스 상품의 구매를 하실 수 있습니다. 아이디어펀는 비회원 주문의 경우 배송 및 대금 결제, 상품 배송에 반드시 필요한 개인정보만을 이용자에게 요청하고 있습니다.
아이디어펀에서 비회원으로 구입을 하신 경우 비회원 이용자가 입력한 지불인 정보 및 수령인 정보는 대금 결제 및 상품 배송에 관련한 용도 외에는 다른 어떠한 용도로도 사용되지 않습니다.

5. 쿠키 및 세션에 의한 개인정보 수집
아이디어펀는 회원인증을 위하여 상품의 버전 별 쿠키 및 세션 방식을 이용하고 있습니다. 이는 로그아웃(Logout)시 자동으로 컴퓨터에 저장되지 않고 삭제되도록 되어 있으므로 공공장소나 타인이 사용할 수 있는 컴퓨터를 사용 하 실 경우에는 로그인(Login)후 서비스 이용이 끝나시면 반드시 로그아웃(Logout)해 주시기 바랍니다.

- 쿠키(cookie)란? 
쿠키는 웹사이트가 귀하의 컴퓨터 브라우저(넷스케이프, 인터넷 익스플로러 등)로 전송하는 소량의 정보입니다. 귀하께서 웹사이트에 접속을 하면 컴퓨터는 귀하의 브라우저에 있는 쿠키의 내용을 읽고, 귀하의 추가정보를 귀하의 컴퓨터에서 찾아 접속에 따른 성명 등의 추가 입력 없이 서비스를 제공할 수 있습니다. 쿠키는 귀하의 컴퓨터는 식별하지만 귀하를 개인적으로 식별하지는 않습니다.
- 세션(Session)이란?
사용자의 접속정보를 서버에 저장하는 방식입니다.

6. 개인정보의 보유기간 및 이용기간
이용자가 쇼핑몰 회원으로서 회사에 제공하는 서비스를 이용하는 동안 아이디어펀는 이용자들의 개인정보를 계속적으로 보유하며 서비스 제공 등을 위해 이용합니다. 다만, 개인정보취급방침 전체 내용 중 "8. 개인정보의 열람, 정정, 삭제 " 에서 설명한 절차와 방법에 따라 이용자 본인이 직접 삭제하거나 수정한 정보, 가입해지를 요청한 경우에는 재생할 수 없는 방법에 의하여 디스크에서 완전히 삭제하며 추후 열람이나 이용이 불가능한 상태로 처리됩니다.
...
그리고 상법, 전자상거래 등에서의 소비자보호에 관한 법률 등 관계법령의 규정에 의하여 보존할 필요가 있는 경우 아이디어펀는 관계법령에서 정한 일정한 기간 동안 회원정보를 보관합니다. 이 경우 아이디어펀는 보관하는 정보를 그 보관의 목적으로만 이용하며 보존기간은 아래와 같습니다.

- 계약 또는 청약철회 등에 관한 기록 : 5년
- 대금결제 및 재화 등의 공급에 관한 기록 : 5년
- 소비자의 불만 또는 분쟁처리에 관한 기록 : 3년

아이디어펀는 귀중한 이용자의 개인정보를 안전하게 처리하며, 유출의 방지를 위하여 다음과 같은 방법을 통하여 개인정보를 파기합니다.
종이에 출력된 개인정보는 분쇄기로 분쇄하거나 소각을 통하여 파기합니다. 전자적 파일 형태로 저장된 개인정보는 기록을 재생할 수 없는 기술적 방법을 사용하여 삭제합니다.</textarea>
			<br /> <input type="radio" name="identifyuse" value="agree" />동의합니다
			<input type="radio" name="identifyuse" value="notagree" />동의하지 않습니다 <br />
			<br />
			<div style="width:100%; padding-left:25%">
				<a href="#"><img src="resources/images/btn_join.gif" id="submit" /></a>
				<a href="javascript:history.back()"><img src="resources/images/btn_back.gif" id="back" /></a>
			</div>
		</div>
	</div>
</body>
